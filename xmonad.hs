...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["Arandr", "Arcolinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal", "timeshift"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
 ...
 -- , ((modMask, xK_m), spawn $ "pragha" )
  ...
  , ((modMask, xK_F3), spawn $ "whatsapp-nativefier" )
  , ((modMask, xK_F4), spawn $ "spotify" )
  , ((modMask, xK_F5), spawn $ "skypeforlinux" )
  , ((modMask, xK_F6), spawn $ "vlc --video-on-top" )
  , ((modMask, xK_F7), spawn $ "chromium" )
  , ((modMask, xK_F8), spawn $ "firefox-developer-edition" )
  , ((modMask, xK_F9), spawn $ "vim ~/.xmonad/xmonad.hs" )
 ...
 -- , ((controlMask, xK_Print), spawn $ "xfce4-screenshooter" )
  , ((controlMask .|. shiftMask , xK_p ), spawn $ "gnome-screenshot -i")
